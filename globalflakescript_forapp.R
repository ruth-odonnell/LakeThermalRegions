...
list.files("R://ShinyApps//lakebiomes")
save(globalflakemat, file="R://ShinyApps//lakebiomes//globalflakemat.Rdata")
save(globalpos, file="R://ShinyApps//lakebiomes//globalpos.Rdata")
...
foy <- time1$yday %/% 7 
foy
save(foy, file="R://ShinyApps//lakebiomes/foy.Rdata")
...
load("Z:/GL/Flake/May2017/arc_fpca.Rdata", verbose=TRUE)
load("Z:/GL/Flake/May2017/arcfd.Rdata", verbose=TRUE)
...
for(i in sids){
  sc10[i,] <- inprod(arc.fpc$harmonics, globalfd[i]-meanfd)
  print(i)
}
